...
var (
	// limit for pow+pos
	BaseLimitBalanceNumber		*big.Int=big.NewInt(0)	//the epoch number
	BaselimitPosBalance	*big.Int = big.NewInt(0)	//the first balance limit
	BaselimitSubBalance *big.Int = big.NewInt(0)	//the minuend
	LastLimitBalance *big.Int=big.NewInt(0)//the last limitbalance is 100000
)
